...
public class CreateTransferenciaDTO {
    ...
    @NotBlank(message = "Deber ingresar una cuenta de crédito.")
    private String cuentaCredito;

    @NotBlank(message = "Debe ingresar el ID de la empresa correspondiente.")
    private Long idEmpresa;

    public CreateTransferenciaDTO() {
    }

    public CreateTransferenciaDTO(Double importe, String cuentaDebito, String cuentaCredito, Long idEmpresa) {
